...
all_novels_char <- bind_rows(all_novels_char_both, all_novels_auth_gender, all_novels_race)
write.csv(all_novels_char, "data/all_novels_char")

novels_with_stop_list_race <- list(w_unnest, b_unnest)
novels_with_stop_list_char_gender <- list(fem_unnest_char_gender, male_unnest_char_gender)
novels_with_stop_list_char_both <- list(wm_unnest_char, wf_unnest_char, bf_unnest_char)
novels_with_stop_list_auth_gender <- list(fem_unnest_auth_gender, male_unnest_auth_gender)
novels_with_stop_list_auth_both <- list(wm_unnest_auth, wf_unnest_auth, bf_unnest_auth)
```
...
write.csv(top_10_words_wm_auth, "data/top_10_words_wm_auth")
write.csv(top_10_words_wf_auth, "data/top_10_words_wf_auth")
write.csv(top_10_words_bf_auth, "data/top_10_words_bf_auth")
